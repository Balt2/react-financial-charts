...
import { getStrokeDasharray, getStrokeDasharrayCanvas, isDefined } from "@react-19-financial-charts/core";
...
export const renderSVG = (props: any) => {
    ...
    if (edge.line !== undefined) {
        line = (
            <line
                className="react-19-financial-charts-cross-hair"
        ...
        coordinateBase =
            edge.orient === "left" || edge.orient === "right" ? (
                <g key={1} transform={`translate(${edge.coordinateBase.edgeXRect},${edge.coordinateBase.edgeYRect})`}>
                    <path
                        d={path}
                        className="react-19-financial-charts-text-background"
                        height={rectHeight}
                        width={rectWidth}
