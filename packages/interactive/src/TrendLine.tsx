...
import { isDefined, isNotDefined, noop, strokeDashTypes } from "@react-19-financial-charts/core";
                ...
                {trends.map((each, idx) => {
                    ...
                    return (
                        <EachTrendLine
                            ...
                            edgeInteractiveCursor="react-19-financial-charts-move-cursor"
                            lineInteractiveCursor="react-19-financial-charts-move-cursor"
                        />
                    );
                })}
                {tempLine}
