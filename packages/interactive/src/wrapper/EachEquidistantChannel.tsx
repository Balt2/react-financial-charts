...
import { isDefined, noop } from "@react-19-financial-charts/core";
            ...
            isDefined(startXY) && isDefined(endXY) ? (
                <g>
                    {this.getEdgeCircle({
                        ...
                        cursor: "react-19-financial-charts-move-cursor",
                        fill: edgeFill,
                        edge: "line1edge1",
                    })}
                    {this.getEdgeCircle({
            ...
            dy !== undefined && isDefined(dy) ? (
                <g>
                    {this.getEdgeCircle({
                        ...
                        cursor: "react-19-financial-charts-ns-resize-cursor",
                        fill: edgeFill2,
                        edge: "line2edge1",
                    })}
                    {this.getEdgeCircle({
        ...
        return (
            <g>
                <ChannelWithArea
                    ...
                    fillStyle={fill}
                    interactiveCursorClass="react-19-financial-charts-move-cursor"
