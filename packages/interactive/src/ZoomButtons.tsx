import { ChartContext, last } from "@react-19-financial-charts/core";
...
export class ZoomButtons extends React.Component<ZoomButtonsProps> {
    ...
    public render() {
        ...
        return (
            <g className="react-19-financial-charts-zoom-buttons">
                <circle
                    className="react-19-financial-charts-button"
                    cx={zoomOutX - r / 2}
                    cy={y + r / 2}
                    fill={fill}
                ...
                <circle
                    className="react-19-financial-charts-enable-interaction out"
                ...
                />
                <circle
                    className="react-19-financial-charts-enable-interaction in"
                ...
                />
                <circle
                    className="react-19-financial-charts-enable-interaction reset"
                    onClick={onReset}
                    cx={resetX - r / 2}
                    cy={y + r / 2}
                    r={r}
