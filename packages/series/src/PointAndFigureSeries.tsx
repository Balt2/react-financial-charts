...
import { isDefined, isNotDefined, getAxisCanvas, GenericChartComponent } from "@react-19-financial-charts/core";
...
export class PointAndFigureSeries extends React.Component<PointAndFigureSeriesProps> {
    public static defaultProps = {
        className: "react-19-financial-charts-point-and-figure",
        strokeWidth: 1,
        stroke: {
            up: "#6BA583",
            down: "#FF0000",
